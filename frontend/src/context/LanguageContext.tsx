...
const DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    hero_search_cta: "Explore 52 Public Works",
  ...
  hi: {
    ...
    hero_search_cta: "52 विकास कार्यों का अन्वेषण करें",
  ...
  te: {
    ...
    hero_search_cta: "52 ప్రజా పనులను అన్వేషించండి",
  ...
  ta: {
    ...
    hero_search_cta: "52 வளர்ச்சிப் பணிகளைப் பார்க்கவும்",
  ...
  bn: {
    ...
    hero_search_cta: "৫২টি জনকল্যাণমূলক কাজ দেখুন",
  ...
  mr: {
    ...
    hero_search_cta: "५२ विकास कामे तपासा",
  ...
  kn: {
    ...
    hero_search_cta: "52 ಸಾರ್ವಜನಿಕ ಕಾಮಗಾರಿಗಳನ್ನು ವೀಕ್ಷಿಸಿ",
